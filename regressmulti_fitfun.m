function [fitness,gp,theta,ypredtrain,fitnessTest,ypredtest,pvals,r2train,...
    r2test,r2val,geneOutputs,geneOutputsTest,geneOutputsVal]=regressmulti_fitfun(evalstr,gp)
...
pat = 'x(\d+)';
evalstr = regexprep(evalstr,pat,'gp.userdata.xtrain(:,$1)'); %$1 makes x1 and x2 things 
